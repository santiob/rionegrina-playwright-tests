...
git clone https://github.com/santiob/rionegrina-playwright-tests.git
cd rionegrina-playwright-tests
...
│   ├── juegos.spec.js     # Tests de juegos
